...
function resolveOpenAICodexSettings(value) {
	...
	return {
		...resolved,
		enableAutoReview: resolved.enableAutoReview && resolved.autoReviewDisclosureAcknowledged,
