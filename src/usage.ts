...
export function parseOpenAICodexUsage(value: unknown): OpenAICodexUsage {
  ...
  // Some responses retain a legacy five-hour-shaped window even when the
  // detected plan does not meter it. Only plans with a confirmed 5h window
  // expose that row to the browser.
